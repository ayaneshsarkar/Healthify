...
const HomeWorkout: FC<PlanItemImageProps> = ({ width, height }) => {
  return (
    <Svg width={width} height={height} viewBox='0 0 511.999 511.999'>
      <G>
        <Path
          fill="#E6773D"
          d='M238.932,491.651l-9.315-177.423l-17.165,0.902l8.971,170.865l0.328,0.105l-24.919,9.14
        ...
        <Path
          fill="#E6773D"
          d='M273.067,491.651l9.315-177.423l17.165,0.902l-8.971,170.865l-0.328,0.105l24.919,9.14
        ...
        <Path
          fill="#E6773D"
          d='M406.729,94.236c-4.741-0.515-8.962,2.892-9.478,7.61c-2.649,24.243-14.582,46.003-33.597,61.27
      ...
      <Circle fill="#5C4853" cx='255.997' cy='21.772' r='21.772' />
      <Path
        fill="#39C8C6"
        d='M284.934,171.922h-57.869c-10.616,0-19.301,8.685-19.301,19.301v111.943
	c0,26.639,21.596,48.235,48.235,48.235s48.235-21.596,48.235-48.235V191.223C304.234,180.607,295.55,171.922,284.934,171.922z'
      ...
      <Path
        fill="#E6773D"
        d='M305.713,93.267c0,27.462-22.259,49.704-49.722,49.704c-27.444,0-49.704-22.241-49.704-49.704
	s22.261-49.722,49.704-49.722C283.452,43.545,305.713,65.805,305.713,93.267z'
      ...
      <G>
        <Path
          fill="#5C4853"
          d='M71.827,134.292c-4.746,0-8.594-3.847-8.594-8.594V79.861c0-4.748,3.848-8.594,8.594-8.594
		s8.594,3.847,8.594,8.594v45.837C80.421,130.444,76.573,134.292,71.827,134.292z'
        />
        <Path
          fill="#5C4853"
          d='M140.582,134.292c-4.746,0-8.594-3.847-8.594-8.594V79.861c0-4.748,3.848-8.594,8.594-8.594
      ...
      <G>
        <Path
          fill="#5C4853"
          d='M371.417,134.292c-4.746,0-8.594-3.847-8.594-8.594V79.861c0-4.748,3.848-8.594,8.594-8.594
		c4.746,0,8.594,3.847,8.594,8.594v45.837C380.012,130.444,376.164,134.292,371.417,134.292z'
        />
        <Path
          fill="#5C4853"
          d='M440.172,134.292c-4.746,0-8.594-3.847-8.594-8.594V79.861c0-4.748,3.848-8.594,8.594-8.594
		c4.746,0,8.594,3.847,8.594,8.594v45.837C448.767,130.444,444.919,134.292,440.172,134.292z'
        />
      </G>
      <Path
        fill="#76DEDD"
        d='M303.052,85.82h-94.105c-4.746,0-8.594-3.847-8.594-8.594s3.848-8.594,8.594-8.594h94.105
